...
export const AdminTrustLevelRulesPage: React.FC = () => {
  const { user } = useAuth();
  const queryClient = useQueryClient();

  const isAdmin = !!user && user.usuarioInfoDTO.roles.includes("ADMIN");
    ...
    return (
      <div className="space-y-6">
        <PageHeader
          ...
          description="Acceso restringido: solo administradores."
        />
        <Card>
          <CardContent>
